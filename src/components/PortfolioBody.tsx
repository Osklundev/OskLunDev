...
export const PortfolioBody = () => {
  return (
    <div id="body" className="min-h-screen flex flex-col gap-4">
      <section>
        <h2 className="text-center font-bold border-b-2 max-w-30 m-auto">
          Who am I?
        </h2>
        <div className="p-2 flex flex-column min-w-full border-b-5">
          ...
          <div className="min-w-1/2 text-center flex flex-col justify-around">
            <p>
